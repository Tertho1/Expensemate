<footer class="bg-dark text-white py-12 mt-16">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-1">
                <div class="flex items-center mb-4">
                    ...
                    <span class="ml-2 text-2xl font-bold">Expense<span class="text-accent">Mate</span></span>
                </div>
                <p class="text-gray-400">
                    Smart expense tracking for individuals and businesses. Take control of your finances with our intuitive tools.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    @auth
                        <li><a href="{{ route('transactions.index') }}" class="text-gray-400 hover:text-white transition">Dashboard</a></li>
                        <li><a href="{{ route('analytics') }}" class="text-gray-400 hover:text-white transition">Analytics</a></li>
                    @else
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-500 text-sm">© {{ date('Y') }} ExpenseMate. All rights reserved.</p>
